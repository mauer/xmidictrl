...
| map Type | Name      | Description and Usage                                                         |
|:------------:|-----------|-------------------------------------------------------------------------------|
| cmd          | Command   | Executes a X-Plane command                                                    |
| pnp          | Push&Pull | Simulates a Push&Pull button and can therefore execute two different cmd |   
| drf          | DataRef   | Toggles a given DataRef between two values                                    |
| enc          | encoder   | Executes different cmd for up/down and fast up/fast down                 |
| int          | Internal  | Performs internal cmd (not implemented yet)                              |
...
###
### encoder
map for an encoder (knob). You can define a command for up (right turn) and down (left turn). In addition, it's 
...
cmd for a faster heading up and down*
